    ...
    <div className="rounded-3xl border border-neutral-800 bg-neutral-900 p-4 shadow-2xl">
      <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
        ...
        <div className="flex flex-col gap-3 md:flex-row md:items-center">
          ...
          <div className="relative">
            <Target className="h-4 w-4 text-neutral-500 absolute left-3 top-1/2 -translate-y-1/2" />
            <select
              value={goalTypeFilter}
              onChange={(e) => onChangeGoalTypeFilter(e.target.value)}
              className="w-full md:w-44 rounded-2xl bg-neutral-800 border border-neutral-700 pl-10 pr-4 py-2.5 text-sm outline-none appearance-none"
            >
